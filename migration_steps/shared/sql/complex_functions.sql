...
BEGIN
	report_status = CASE
		...
		WHEN report_aggr_code like 'N_%_Y_Y_Y_%' THEN 'LODGED||NO_REVIEW'
		...
		WHEN report_aggr_code like 'S_%_N_N_%_%' THEN 'OVERDUE||NO_REVIEW'
		WHEN report_aggr_code like 'R_%_N_N_N_%' THEN 'OVERDUE||NO_REVIEW'
		WHEN report_aggr_code like 'R_%_Y_N_N_%' THEN 'DUE||STAFF_REFERRED'
		WHEN report_aggr_code like 'R_%_Y_Y_N_%' THEN 'OVERDUE||NO_REVIEW'
