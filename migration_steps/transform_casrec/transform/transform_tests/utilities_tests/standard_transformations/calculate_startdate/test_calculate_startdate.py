...
@parametrize_with_cases("enddate, expected_startdate", cases=".", prefix="case_calculate_startdate")
def test_calculate_startdate(enddate, expected_startdate):
    ...
    for index, row in result.iterrows():
            ...
            assert row['startdate'] == expected_startdate, f'startdate value was not correct'
