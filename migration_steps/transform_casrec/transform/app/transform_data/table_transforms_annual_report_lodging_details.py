...
_all_date_cols = _rcvd_date_cols + _sent_date_cols + [
    'c_lodge_date',
    'c_review_date',
    'c_revise_date',
    'c_followup_date'
...
_mappings = [
    ...
    # table 1, row 8
    {
        ...
        'output_cols': {
            'lodgedstatus': 'REFERRED_FOR_REVIEW'
        }
    },
    # table 1, row 9
    {
        ...
        'criteria': [
            {
                'all_unset': [
                    ...
                    'c_revise_date',
                    'c_followup_date'
                ] + _rcvd_date_cols + _sent_date_cols
            }
        ],
        'output_cols': {
            'lodgedstatus': 'REFERRED_FOR_REVIEW'
