...
Boolean, default False; if True, once a set of criteria matches a row and transforms it,
no further matches will be made against that row. This means that the first matching set of
criteria (barring the default_cols mapping) will be applied to the row, and no others.
If False, the criteria will be applied in sequence to the row, and the last matching
mapping will provide the output.
"""
