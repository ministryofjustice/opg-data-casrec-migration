...
from transformations.standard_transformations import populate_required_columns


def test_populate_required_columns():
    required_columns = {
    ...
    result_df = populate_required_columns(test_data_df, required_columns)
