...
then
  ...
  if [ "${CORREFS}" == "" ]
  then
    DEFAULT_P2_CORREFS="A1,A2,A2A,A3,A3G,ADC,ARD,C1,DCC,DCS,DND,DNP,DOD,DOL,EPA,FMT,FOE,HW,JSU,L1,L2,L2A,L3,L3G,LDC,NA,NAD,NEW,NT,OBE,ODP,ORS,ORV,P2,P2A,P3,P3G,PDC,PGA,PGB,PGC,PGH,PGL,PGR,RGY,S1A,S1N,SGD"
